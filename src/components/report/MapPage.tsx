...
const MapPage = ({ properties, theme, mapImage }: { properties: any[], theme?: { primary: string, secondary: string }, mapImage?: string }) => {
    ...
    return (
        <div className="print-page h-[1123px] w-[794px] bg-white p-12 flex flex-col">
            ...
            <div className="flex-1 border border-slate-200 rounded-lg flex items-center justify-center bg-slate-50 mb-8 overflow-hidden">
                {mapImage ? (
                    <img src={mapImage} alt="Mapa de Ubicación" className="w-full h-full object-contain" crossOrigin="anonymous" />
                ) : (
